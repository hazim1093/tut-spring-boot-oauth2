...
2. Run the application by mvn spring-boot:run
3. Navigate to http://localhost:8080
4. Click on the login with facebook link and log in the application.
5. After logging in, a button "Test" will be available, click this button to retrieve public profile information for facebook via the facebook access token that was stored when you logged in the application.
